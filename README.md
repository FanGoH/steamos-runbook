...
| `scripts/ensure-mangohud-presets.sh` | Steam QAM performance overlay preset 2: keep the horizontal bar/graphs, drop `horizontal_stretch` and HUD `background_alpha` so the 1080p mangoapp overlay does not 1/4-flash on 4K HDMI. Other presets stay stock. |
