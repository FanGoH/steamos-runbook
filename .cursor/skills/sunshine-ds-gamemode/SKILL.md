...
- **4K HDMI + 1080p `:2`:** Steam status-bar resize / black flicker is the Cemu/Azahar focus loop forcing the **TV** window to 1920×1080 while session X is 3840×2160. Size TV with `gamescope_session_size`. Do not resize `:2` / GamePad to 4K.

## What must be true

| Surface | Idle (Desktop `958645192`) | Cemu playing |
|---|---|---|
| HDMI / Thor top (video/0) | Steam Big Picture / focused game | Cemu TV (`------- Init Cemu`) at **live session size** (4K HDMI → 3840×2160). Do not force 1920×1080 on the TV window — that shrinks Steam’s status bar, fullscreen snaps back, black flicker. |
...
- Force Cemu/Azahar TV to 1920×1080 when HDMI/session is 4K (status-bar resize + black flicker). Use `gamescope_session_size`. Keep GamePad / `:2` at 1920×1080.
