...
Cemu uuid is ``{sdl-index}_{guid}`` (SDL2 CRC-16 of the device name). Player 0
is written as the first ``<controller>`` in controller0.xml. Cemu must restart
to pick up a uuid change.
