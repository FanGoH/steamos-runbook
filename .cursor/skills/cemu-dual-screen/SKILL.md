...
## Game Mode (`:48200`) — checkpoint `checkpoint-2026-09-10-gamemode-dual-stream`

User confirmed 2026-09-10: Thor both screens, Steam overlay, bottom screensaver, then Wind Waker TV + GamePad. Do not “improve” this unless it breaks. Full recipe: `.cursor/skills/sunshine-ds-gamemode/SKILL.md`. Sep 9 `checkpoint-2026-09-09-gamemode-cemu-ds` is the HDMI DCC / Cemu-picture baseline.
