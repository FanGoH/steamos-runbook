...
- Game Mode `:48200` Cemu GamePad touch checkpoint (2026-09-09, tag `checkpoint-2026-09-09-gamemode-cemu-touch`, sunshine-ds `1dfeb53c`): Odin **Stack both** and Thor **dual-panel** taps work on Wind Waker. Odin **GamePad only** was a no-op at that tag (display 0). Host commits after the tag route `primary_from_secondary` onto GamePad View. Do not merge into play / `:48100`.
