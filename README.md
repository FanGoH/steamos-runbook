...
| `scripts/ensure-sunshine-ds-gamemode.sh` | Isolated Game Mode KMS experiment (`sunshine-ds-kms` host + RUNPATH, `:48200`). Not Distrobox. Does not touch `:48100` / `sunshine-ds-dev`. |
