...
- Game Mode `:48200` Cemu GamePad touch checkpoint (2026-09-09, tag `checkpoint-2026-09-09-gamemode-cemu-touch`, sunshine-ds `1dfeb53c`): Odin **Stack both** and Thor **dual-panel** taps work on Wind Waker. Odin **GamePad only** does not (display 0 / GamePad-as-primary). Host `sunshine-ds-kms`, `dual_display_source = gamescope-virtual`. Do not merge into play / `:48100`.
